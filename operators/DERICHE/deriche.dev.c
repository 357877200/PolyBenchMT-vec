...
__global__ void deriche_kernel1_vec(int w, int h, double a1, double a2, double b1, double b2,
                            double *imgIn, double *y1)
{
    int thread_id = get_thread_id();
    int group_size = get_group_size();
...
__global__ void deriche_kernel2_vec(int w, int h, double a3, double a4, double b1, double b2,
                            double *imgIn, double *y2)
{
    int thread_id = get_thread_id();
    int group_size = get_group_size();
...
__global__ void deriche_kernel4_vec(int w, int h, double a5, double a6, double b1, double b2,
                            double *imgOut, double *y1)
{
    int thread_id = get_thread_id();
    int group_size = get_group_size();
...
__global__ void deriche_kernel5_vec(int w, int h, double a7, double a8,
                             double b1, double b2,
                             double *imgOut, double *y2)
{
    int thread_id = get_thread_id();
...
#include "../DERICHE/kernel_vec.h"
#include "../DERICHE/kernel_cache_llm.h"//SM缓存优化文件